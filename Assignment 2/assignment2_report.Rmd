...
Initially, we used `random forest` algorithms. We fitted the model by using the training data and cross validation techniques to predict our target variable.
...
rf_performance = confusionMatrix(rf_pred, as.factor(y_test), mode = "everything",positive = '1')
...
if(!file.exists("C:/Users/doduc/Github/Socialscience_bigdata_KUL/Assignment 2/gb_model.rds")){
  gb_model = train(x = x_train,y = as.factor(y_train), method = 'gbm', 
                 trControl = train_control)
} else {
  gb_model = readRDS("C:/Users/doduc/Github/Socialscience_bigdata_KUL/Assignment 2/gb_model.rds")
...
gb_performance = confusionMatrix(gb_pred, as.factor(y_test), mode = "everything",positive = '1')
...
if(!file.exists("C:/Users/doduc/Github/Socialscience_bigdata_KUL/Assignment 2/xg_model.rds")){
  xg_model = train(x = x_train,y = as.factor(y_train), method = 'xgbTree', 
                 trControl = train_control)
} else {
  xg_model = readRDS("C:/Users/doduc/Github/Socialscience_bigdata_KUL/Assignment 2/xg_model.rds")
...
xg_performance = confusionMatrix(xg_pred, as.factor(y_test), mode = "everything",positive = '1')
...
if(!file.exists("C:/Users/doduc/Github/Socialscience_bigdata_KUL/Assignment 2/xg_model.rds")){
  ...
  lr_model = readRDS("C:/Users/doduc/Github/Socialscience_bigdata_KUL/Assignment 2/lr_model.rds")
...
lr_performance = confusionMatrix(lr_pred, as.factor(y_test), mode = "everything",positive = '1')
...
if(!file.exists("C:/Users/doduc/Github/Socialscience_bigdata_KUL/Assignment 2/sv.rds")){
  ...
  sv = readRDS("C:/Users/doduc/Github/Socialscience_bigdata_KUL/Assignment 2/sv.rds")
