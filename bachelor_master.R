...
#Do they do Masters after Bachelors and if so, from where (local or abroad)?
...
other_edu <- anti_join(edu, relevant_edu, by = "employee_id")
...
combined_table <- rbind(bachefield_yes, bachefield_no, total)
