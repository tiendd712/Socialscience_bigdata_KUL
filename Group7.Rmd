...
We implement a Random Forest and Logistic Regression model to analyze the association between various features and the likelihood of employee promotions.
...
smote_train <- ovun.sample(promote_general ~ ., data = data_smote_general, method = "both", N = length(data_smote), seed = 7)$data
