...
The objective of the model is to forecast the 'promote_general' outcome, which indicates whether an individual progresses to any higher job level or not. 
...
```
The model results revealed several noteworthy inferences based on significant explanatory variables, as outlined below:
time_work:
intern:
num_job:
num_company:
