...
After gaining access to the LinkedIn platform, the browser then navigates to the desired LinkedIn page by providing the relevant URL. In this case, the provided URL led to the KU Leuven school page with customized filters applied for the specific keywords to narrow down the search.

```{python query, eval=FALSE}
browser.get(paste("https://www.linkedin.com/school/ku_leuven/people/?keywords=",
                  "Data%20scientist%20OR%20data%20analyst%20OR%20data%20engineer%",
                  "20OR%20machine%20learning%20engineer%20OR%20statistician", 
                  sep = ""))
```
...
An instance of user information that we collect from Linkedin using `linkedin_api` would be presented in the following link https://github.com/tiendd712/Socialscience_bigdata_KUL/blob/master/Assignment%203/linkedin_scraper/profiles_demo.json
...
image_url = paste("https://media.licdn.com/dms/image/C5603AQHHUuOSlRVA1w/profile",
                  "-displayphoto-shrink_400_400/0/1579726624860?e=1698278400&v=",
                  "beta&t=Ada1aikVFfwnXHb6Xd-d9FpJTPsNAGch2Jv5WdAAIMw", sep = "")
...
kable_styling(knitr::kable(head(skill$skill_trans, 5)), 
              full_width = FALSE, latex_options = "scale_down")
...
```{r skill-lda-3, message=FALSE, warning=FALSE}
# LDA - 3 topics
set.seed(7)
...
```{r skill-lda-8, message=FALSE, warning=FALSE}
# LDA - 8 topics
set.seed(7)
...
kable_styling(knitr::kable(tail(df_level_1, 5)), 
              full_width = FALSE, latex_options = "scale_down")
